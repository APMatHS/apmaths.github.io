/* AI-CLO PTITHCM V12.6.52 — on-demand loader for independent utilities only.
...
const MOODLE_EXPORT='js/questions/moodle-export.js?v=12.6.52';
...
async function bootstrapIndependentFeatures(){installNavigationGate();for(const [src,label] of [[AI_CLONE,'AI clone'],[COURSE_AI_GUIDE,'course AI guide'],[MOODLE_EXPORT,'Bank download']]){try{await loadScript(src)}catch(e){console.error(`AI-CLO ${label} module load failed`,e)}}}
