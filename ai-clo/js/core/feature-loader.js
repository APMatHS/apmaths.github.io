/* AI-CLO PTITHCM V12.6.50 — on-demand loader for independent utilities only.
...
async function bootstrapIndependentFeatures(){installNavigationGate();for(const [src,label] of [[AI_CLONE,'AI clone'],[COURSE_AI_GUIDE,'course AI guide']]){try{await loadScript(src)}catch(e){console.error(`AI-CLO ${label} module load failed`,e)}}}
